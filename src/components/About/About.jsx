...
const About = () => {
    return(
        <Container>
            ...
            <p>
                You can add quotes to your watchlist to keep an eye on it, along with other companies.
            </p>
            ...
            <p>
            Enter the stock market symbol for any us listed company into the search box and hit search.
            You will see a quote on the company's share price and brief details on the company.
